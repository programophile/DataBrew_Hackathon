...
import { Coffee, Eye, EyeOff, Sparkles, Check } from "lucide-react";
...
export function SignupPage({ onSignup, onSwitchToLogin }: SignupPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#f9f5f2] flex items-center justify-center p-4 py-12">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-[#fffaf3] rounded-full opacity-30 blur-3xl"></div>
      </div>
      ...
      <div className="relative w-full max-w-lg">
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/50 p-8 relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-[#8b5e3c] mb-2">Start Your Journey</h1>
            <p className="text-[#8b5e3c]/70">Create your BrewMind Analytics account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Coffee Shop Name */}
            <div>
              <label htmlFor="shopName" className="block text-[#8b5e3c] mb-2">
                Coffee Shop Name
              </label>
              <input
                id="shopName"
            ...
            {/* Full Name */}
            <div>
              <label htmlFor="fullName" className="block text-[#8b5e3c] mb-2">
                Your Full Name
              </label>
              <input
                id="fullName"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-[#8b5e3c] mb-2">
                Confirm Password
              </label>
              <div className="relative">
                <input
            ...
            <div className="flex items-start gap-3 pt-2">
              <div className="relative flex items-center justify-center">
                <input
                  ...
                  className="w-5 h-5 rounded border-[#d8c3a5] text-[#8b5e3c] focus:ring-[#8b5e3c] focus:ring-offset-0 cursor-pointer"
                  required
                />
              </div>
              <label htmlFor="terms" className="text-[#8b5e3c]/70 cursor-pointer -mt-0.5">
                I agree to the{" "}
                <a href="#" className="text-[#8b5e3c] hover:text-[#b08968] transition-colors">
                  Terms of Service
                </a>{" "}
                and{" "}
                <a href="#" className="text-[#8b5e3c] hover:text-[#b08968] transition-colors">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-[#8b5e3c] to-[#b08968] text-white py-3 rounded-xl hover:shadow-lg hover:shadow-[#8b5e3c]/30 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2 group mt-6"
            >
            ...
            {/* Features List */}
            <div className="mt-6 p-4 bg-[#fffaf3] rounded-xl border border-[#d8c3a5]">
              <p className="text-[#8b5e3c] mb-3">What you'll get:</p>
              <div className="space-y-2">
                {[
                  "AI-powered sales & inventory insights",
                  "Real-time cash flow analytics",
                  "Staff scheduling & management",
                  "Customer trend analysis",
                ].map((feature, index) => (
                  <div key={index} className="flex items-center gap-2">
                    <div className="flex items-center justify-center w-5 h-5 bg-[#8b5e3c] rounded-full">
                      <Check className="w-3 h-3 text-white" />
                    </div>
                    <span className="text-[#8b5e3c]/80">{feature}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center">
                <span className="px-4 bg-white/80 text-[#8b5e3c]/60">or sign up with</span>
              </div>
            </div>
